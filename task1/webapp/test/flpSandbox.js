		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comemopiptask1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comemopiptask1-display": {
								"semanticObject": "comemopiptask1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.emo.pip.task1",
									"url": sap.ui.require.toUrl("com/emo/pip/task1")
								}
							}
						}
					}
